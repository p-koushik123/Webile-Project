...
//       setStep(2);
//     } else {
//       if (!formData.username || !formData.fullName || formData.password.length < 8) {
//         toast.error('Please fill in all fields and ensure password is at least 8 characters long');
//         return;
//       }
//       mutate(formData);
//     }
...
//         <div className="flex flex-col items-center mb-6">
//           <PkLogo className="w-16 h-16 mb-4" />
//           <h1 className="text-3xl font-extrabold">{step === 1 ? 'Get Started' : 'Almost There!'}</h1>
//         </div>
//         <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
//           {step === 1 ? (
...
//                 />
//                 {showPassword ? (
//                   <MdVisibilityOff className="text-lg cursor-pointer" onClick={() => setShowPassword(false)} />
//                 ) : (
//                   <MdVisibility className="text-lg cursor-pointer" onClick={() => setShowPassword(true)} />
//                 )}
//               </label>
//             </div>
//           )}
//           <button className="btn bg-purple-600 text-white rounded-full py-3 text-lg font-semibold hover:bg-purple-700 transition-all">
//             {step === 1 ? 'Next' : 'Sign Up'}
//           </button>
//         </form>
//       </div>
...
//             {step === 1 ? 'Enter your email to begin' : 'Complete your profile'}
//           </p>
//         </div>
...
//             <input
//               type="email"
//               className="input input-bordered rounded-full p-4"
//               placeholder="Your email address"
//               name="email"
...
//                 <input
//                   type={showPassword ? 'text' : 'password'}
//                   className="input input-bordered rounded-full p-4 w-full"
//                   placeholder="Password"
//                   name="password"
...
//             </>
//           )}
//           <button className="btn bg-purple-600 text-white rounded-full py-3">
//             {step === 1 ? 'Next' : 'Sign Up'}
//           </button>
//         </form>
    ...
    <div className="fixed inset-0 flex items-center justify-center px-4 bg-cover bg-center bg-no-repeat bg-[url('/bg1.jpg')]">
      <div className="w-full max-w-lg p-8 bg-white/30   shadow-xl border border-white/20">
        ...
        <div className="flex flex-col items-center mb-5">
          <PkLogo className="w-16 h-16 mb-4 animate-bounce" />
          <h1 className="text-3xl font-extrabold text-gray-800">
            {step === 1 ? 'Get Started' : 'Almost There!'}
          </h1>
          <p className="text-gray-500">
        ...
        <form className="flex flex-col gap-5 p-6 bg-white/300 backdrop-blur-lg shadow-lg rounded-xl" onSubmit={handleSubmit}>
          {step === 1 ? (
            ...
            <>
              <input
                type="text"
                className="flex-1 bg-transparent border-none outline-none px-4 text-gray-800 placeholder-gray-400 focus:ring-0"
                placeholder="Username"
                name="username"
                onChange={(e) => setFormData({ ...formData, username: e.target.value })}
                value={formData.username}
          ...
          <button className="btn bg-purple-600 text-white rounded-full py-3" disabled={loading}>
...
//flex-1 bg-transparent border-none text-black outline-none px-3

//input input-bordered rounded-full p-4 w-full
